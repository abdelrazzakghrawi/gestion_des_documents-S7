...
function doc() {
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossOrigin="anonymous" />
    ...
    <a className="btn btn-primary btn-sm" href="/documents/releve">
        <i className="fas fa-folder"></i> Ajouter Etudiant
      </a>
      <a className="btn btn-primary btn-sm" href="/documents/attestation">
        <i className="fas fa-folder"></i> Ajouter Etudiant
      </a>
      ...
      <a className="btn btn-primary btn-sm" href="/documents/vacances">
        <i className="fas fa-folder"></i>  Vacances
      </a>
